...
// export default function ManagementList({ managements }) {
//   return (
...
const TABLE_HEAD = ["Member", "Data of birth", "Gender", "Salary", "Tel", "Hire Date", "Issue Date", ""];
    ...
    <Card className="h-full w-full">
      ...
      <CardBody className="overflow-scroll px-0">
        <table className="mt-4 w-full min-w-max table-auto text-left">
          ...
          <tbody>
            {managements.map(
              ({employee_id, first_name, last_name}, index) => {
                const isLast = index === managements.length - 1;
                  ...
                  <tr key={employee_id}>
                    <td className={classes}>
                      <div className="flex items-center gap-3">
                        <Avatar src="https://images.pexels.com/photos/771742/pexels-photo-771742.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt={first_name} size="sm" />
